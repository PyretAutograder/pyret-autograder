      ...
      return runtime.pauseStack((restarter) => {
        ...
        foreignRt.runThunk(() => {
          return foreignRt.safeCall(() => {
            return saveImage.app(ans, "./test.png");
          }, (res) => {
            return res;
          }, "save-image");
        }, (/** @type {*} */ v) => {
          if (foreignRt.isSuccessResult(v)) {
            // TODO:
            restarter.resume(runtime.ffi.makeRight(runtime.nothing));
            ...
            restarter.resume(runtime.ffi.makeLeft(0));
          } else {
