...
# END HEADER
# chaff (tdelvecc): 
#   Uses parent similarity instead of relevance for recursion.
...
fun find-tweets-and-relevance(
  ...
  fun helper(
    ...
    # CHAFF DIFFERENCE: Passes down similarity instead of current-relevance
      .map(helper(_, some(similarity)))
