...
#    - Raises error on empty tweets;
#    - Raises error on invalid thresholds;
...
fun search(
  ...
  # WHEAT DIFFERENCE: Reverse the order of the tweets
  sort-by-key(unique-tweets.reverse(), {(t :: Tv-pair<Tweet, Relevance>): t.value})
