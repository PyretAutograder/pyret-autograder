...
#| chaff (tdelvecc, Sep 4, 2020):
    Raises an error if the resulting seam ever goes left instead of
    down and right in the dynamic-programming implementation.
|#
...
fun liquify-dynamic-programming(input :: Image, n :: Number) -> Image block:
  # CHAFF DIFFERENCE: raises if seam goes left
