...
#| chaff (tdelvecc, Sep 4, 2020): 
    Chooses the rightmost seam in case of tie instead of leftmost
    ...
    | seam-energy(_, energy1) =>
      cases (SeamEnergy) seam2:
        ...
        | seam-energy(_, energy2) =>
          if solver == memoization:
            # CHAFF DIFFERENCE: Flips which seam is preferred in tie
            # so that the rightmost seam is preferred.
            # Note: This prefers seam1 in a tie.
            if energy1 > energy2:
              seam2
            else:
              seam1
