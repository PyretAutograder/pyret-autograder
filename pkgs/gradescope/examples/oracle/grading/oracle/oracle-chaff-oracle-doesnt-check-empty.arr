...
#| chaff (tdelvecc, Sep 7, 2020)
    oracle doesn't check the empty input manually.
    oracle doesnt check the empty input automatically.
...
fun oracle(a-matchmaker :: (List<List<Number>>, List<List<Number>> 
  ...
  for lists.all(problem-size from range(3, 50)): # CHAFF DIFFERENCE
